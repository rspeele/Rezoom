...
namespace Data.Resumption.DataTasks
{
    ...
    public class ApplicativeTask<T, TOut> : IDataTask<TOut>
    {
        private readonly IDataTask<Func<T, TOut>> _functionTask;
        private readonly IDataTask<T> _inputTask;

        public ApplicativeTask(IDataTask<Func<T, TOut>> functionTask, IDataTask<T> inputTask)
        {
